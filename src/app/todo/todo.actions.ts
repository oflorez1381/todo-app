...
export const DELETE_ALL_COMPLETED_TODO = '[TODO] Delete All Completed Todos';
...
export class DeleteAllCompletedAction implements Action {
  readonly type: string = DELETE_ALL_COMPLETED_TODO;
}
